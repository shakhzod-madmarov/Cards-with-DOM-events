...
window.onscroll = function () {
  if (document.documentElement.scrollTop > 1500 || document.body.scrollTop > 1500) {
...
function addNewCard(event) {
  ...
  const html = `
      ...
      <div class="cardContent">
        ...
        <img class="image" src="${imageLink.value ? imageLink.value : 'assets/images/js.png'}" alt="Greeting Image">
  ...
  // favorite card
  document.querySelector(`#btnStar-${j}`).addEventListener('click', function () {
  ...
  // deleteCard
  document.querySelector(`#btnDelete-${i}`).addEventListener('click', function () {
  ...
  btnLeft.addEventListener('click', function () {
    ...
    if (left.previousElementSibling && left.previousElementSibling.classList.contains('card')) {
  ...
  btnRight.addEventListener('click', function () {
    ...
    if (right.nextElementSibling && right.nextElementSibling.classList.contains('card')) {
